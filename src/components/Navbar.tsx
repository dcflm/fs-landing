  ...
  return (
    <nav
      ...
      ${scrolled
          ...
          : "bg-neutral-900/50 py-6 shadow-none"
        }`}
    >
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-4xl font-bold" style={{ color }}>
        fs<span className="text-[#FF3D00]">*</span>
      </span>
    </div>
  );
};
    ...
    >
      <a href={href} className="relative">
        ...
        <span
          ...
          className="absolute -bottom-2 -left-2 -right-2 h-1 origin-left scale-x-0 rounded-full bg-[#FF3D00] transition-transform duration-300 ease-out"
        />
      </a>
      <AnimatePresence>
        {showFlyout && (
...
const CTAs = () => {
  return (
    <div className="flex items-center gap-3">
      ...
      <button className="rounded-lg border-2 border-[#FF3D00] bg-black px-4 py-2 font-semibold text-white transition-colors hover:border-[#FF3D00] hover:bg-[#FF3D00] hover:text-white">
        Schedule a Demo
      </button>
    </div>
  );
  ...
  return (
    <div className="grid h-fit w-full grid-cols-12 shadow-xl lg:h-72 lg:w-[600px] lg:shadow-none xl:w-[750px]">
      <div className="col-span-12 flex flex-col justify-between bg-neutral-950 p-6 lg:col-span-4">
        ...
        <a
          href="#"
          className="flex items-center gap-1 text-xs text-[#FF3D00] hover:underline"
        >
...
const CareersContent = () => {
  return (
    <div className="grid w-full grid-cols-12 shadow-xl lg:w-[750px]">
      <div className="col-span-12 flex flex-col justify-between bg-black p-6 lg:col-span-4">
        <div className="mb-6">
