...
const ShiftingContactForm = () => {
  ...
  return (
    <section id="contact-form" className="p-4 my-44 bg-white">
...
const Form = ({
  ...
  return (
    <form
      ...
      className={`p-8 w-full text-white transition-colors duration-[750ms] ${selected === "company" ? "bg-black" : "bg-[#FF3D00]"
        }`}
    >
      ...
      <div className="mb-6">
        ...
        <input
          ...
          className={`${selected === "company" ? "bg-indigo-700" : "bg-[#BC2D00]"
...
const FormSelect = ({
  ...
  return (
    <div className="border-[1px] rounded border-white overflow-hidden font-medium w-fit">
      <button
        className={`${selected === "individual" ? "text-[#FF3D00]" : "text-white"
      ...
      <button
        className={`${selected === "company" ? "text-indigo-600" : "text-white"
          } text-sm px-3 py-1.5 transition-colors duration-[750ms] relative`}
...
const Images = ({ selected }: { selected: "company" | "individual" }) => {
  return (
    <div id="contact" className="bg-white relative overflow-hidden w-full min-h-[100px]">
      <motion.div
        initial={false}
        animate={{
